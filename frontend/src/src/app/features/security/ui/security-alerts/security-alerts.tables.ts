...
export const GROUP_COLUMNS: ColumnDefinition[] = [
  ...
  { key: 'detectionMode', label: 'Detection mode', sortKey: 'detectionMode', filterKey: 'detectionMode', className: 'mono' },
  { key: 'detectionData', label: 'Detection data', sortKey: 'detectionData', filterKey: 'detectionData', className: 'mono' },
